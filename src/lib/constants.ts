...
export const CERTIFICATES: CertificateItem[] = [
  {
    ...
    pages: ["/about/brochure_cover.png"],
...
export type SpecSection = "features" | "specifications" | "materials";
export type SpecRow = { key: string; value: string; section?: SpecSection };
...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      "/products/page4_img2_1091x947.png",
      "/products/page4_img1_410x419.png",
      "/products/page4_img3_981x927.png",
      "/products/page5_img5_278x477.png",
      "/products/page5_img3_218x387.png",
      "/products/page5_img4_250x408.png",
    ],
    description:
  ...
  },
  {
    ...
    category: "Valves",
    slug: "ball-valves",
    tagline: "Floating, Trunnion Mounted, Forged, Jacketed, 3-Way, Tank Bottom & PFA Lined designs.",
    heroImage: "/products/ball-valves/ball-valves-hero.png",
    images: [
      "/products/ball-valves/ball-valves-hero.png",
      "/products/ball-valves/floating-ball-valve-2pc.png",
      "/products/ball-valves/trunnion-mounted-ball-valve.png",
      "/products/ball-valves/forge-ball-valve-3pc.png",
      "/products/ball-valves/jacketed-ball-valve.png",
      "/products/ball-valves/3-way-ball-valve.png",
      "/products/ball-valves/pfa-lined-ball-valve.png",
      "/products/ball-valves/tank-bottom-ball-valve.png",
    ],
    description:
      "Comprehensive range of high-performance industrial ball valves covering Floating, Trunnion Mounted (2/3 Pcs), Forged Steel, Single Piece Jacketed, 3-Way (T & L Port), Flush/Tank Bottom, and PFA Lined configurations. Engineered to international standards (ISO 17292, API 6D, API 608, BS EN ISO 5208, BS EN 17292) from 15 NB to 700 NB and ASME Class #150 to #2500, with fire-safe, anti-static, full-bore, and cavity-free options for extreme industrial environments.",
    specs: "15 NB – 700 NB | Class #150 – #2500 | Fire Safe & SIL Rated",
    items: [
      "2 Pcs Floating Ball Valve",
      "2/3 Pcs Trunnion Mounted",
      "3 Pcs Forge Ball Valve",
      "Single Piece Jacketed",
      "3-Way T & L Port Floating",
      "Flush / Tank Bottom",
      "PFA Lined Ball Valve",
    ],
    specTable: [
      { key: "Size Range", value: "15 NB to 700 NB" },
      { key: "Pressure Rating", value: "ASME Class #150 / #300 / #600 / #900 / #1500 / #2500" },
      { key: "Design Temperature", value: "-29°C to +425°C (Soft & Metal Seated, PFA Lined up to 200°C)" },
      { key: "Design Standards", value: "ISO 17292, API 608, API 6D, BS EN 17292" },
      { key: "Testing Standards", value: "API 6D / BS EN ISO 5208 / API 598 / BS EN 12266-1" },
      { key: "Face to Face", value: "ASME B16.10 / Manufacturing Standard" },
      { key: "Flange Standard", value: "Flanged ASME B16.5 (RF, RTJ, LFF) / Socket Weld / Screwed / Butt Weld" },
      { key: "Flow Direction", value: "Bi-Directional / Uni-Directional (Flush Bottom)" },
      { key: "Operator Options", value: "Hand Lever / Gear Box / Pneumatic or Electric Actuator" },
      { key: "Body MOC", value: "Carbon Steel / Stainless Steel / Duplex / Special Alloys" },
      { key: "Ball MOC", value: "Stainless Steel / Duplex / Special Alloys" },
      { key: "Seat Options", value: "PTFE / GFT / CFT / TFM / Devlon / PEEK / Metal (CRC / TCC / ST)" },
      { key: "Stem MOC", value: "SS 304L / SS 316L / SS 304 / SS 316 / F51 / 17-4PH / Inconel 718" },
      { key: "Lining Options", value: "PFA / FEP / PVDF / ETFE / Antistatic PFA" },
    ],
    subProducts: [
      {
        name: "Floating Ball Valve",
        model: "2 Pcs Design (Soft & Metal Seated)",
        image: "/products/ball-valves/floating-ball-valve-2pc.png",
        images: [
          "/products/ball-valves/floating-ball-valve-2pc.png",
          "/products/ball-valves/floating-ball-valve-2pc-alt1.png",
          "/products/ball-valves/floating-ball-valve-2pc-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 250 NB" },
          { key: "Pressure Rating", value: "ASME Class #150 / #300 / #600 / #900 / #1500 / #2500" },
          { key: "Design Temp.", value: "-29°C to +425°C (Depending upon MOC)" },
          { key: "Design Standard", value: "ISO 17292, API 608, API 6D" },
          { key: "Testing Std.", value: "API 6D / BS EN ISO 5208 / API 598 / BS EN 12266-1" },
          { key: "Face to Face", value: "ASME B16.10" },
          { key: "End Connection", value: "Flanged ASME B16.5 (RF, RTJ, LFF)" },
          { key: "Flow Direction", value: "Bi-Directional" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel / Duplex / Alloys" },
          { key: "Ball MOC", value: "Stainless Steel / Duplex / Alloys" },
          { key: "Seat Options", value: "PTFE / GFT / CFT / TFM / Devlon / PEEK / Metal (CRC / TCC / ST)" },
          { key: "Stem MOC", value: "SS 304L / SS 316L / SS 304 / SS 316 / F51 / 17-4PH / Inconel 718" },
          { key: "Key Features", value: "Fire Safe, Full Bore, Anti-Static, Live Loading Stem, Solid Ball, Top ISO Pad" },
        ],
      },
      {
        name: "Trunnion Mounted Ball Valve",
        model: "2/3 Pcs Design (Soft & Metal Seated)",
        image: "/products/ball-valves/trunnion-mounted-ball-valve.png",
        images: [
          "/products/ball-valves/trunnion-mounted-ball-valve.png",
          "/products/ball-valves/trunnion-mounted-ball-valve-alt1.png",
          "/products/ball-valves/trunnion-mounted-ball-valve-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "50 NB to 700 NB" },
          { key: "Pressure Rating", value: "ASME Class #150 / #300 / #600 / #900 / #1500 / #2500" },
          { key: "Design Temp.", value: "-29°C to +425°C (Depending upon MOC)" },
          { key: "Design Standard", value: "API 6D / API 608 / ISO 17292" },
          { key: "Testing Std.", value: "API 6D / API 598 / ISO 5208" },
          { key: "Face to Face", value: "ASME B16.10" },
          { key: "End Connection", value: "Flanged ASME B16.5" },
          { key: "Flow Direction", value: "Bi-Directional" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel / Duplex / Alloys" },
          { key: "Ball MOC", value: "Stainless Steel / Duplex / Alloys" },
      ...
      {
        name: "Forge Ball Valves",
        model: "3 Pcs Design",
        image: "/products/ball-valves/forge-ball-valve-3pc.png",
        images: [
          "/products/ball-valves/forge-ball-valve-3pc.png",
          "/products/ball-valves/forge-ball-valve-3pc-alt1.png",
          "/products/ball-valves/forge-ball-valve-3pc-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 50 NB" },
          { key: "Pressure Rating", value: "ASME Class #600, #800 & #1500" },
          { key: "Design Standard", value: "ISO 17292, API 608" },
          { key: "Testing Std.", value: "BS EN ISO 5208 / API 598 / BS EN 12266-1" },
          { key: "Face to Face", value: "Manufacturing Standard" },
          { key: "End Connection", value: "Socket Weld, Screwed & Butt Weld" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel" },
          { key: "Ball MOC", value: "Stainless Steel" },
          { key: "Seat Options", value: "PTFE / GFT / CFT / TFM / PEEK" },
          { key: "Stem MOC", value: "SS 304 / SS 316 / F316L / F304L / 17-4PH" },
        ],
      },
      {
        name: "Single Piece Jacketed Ball Valve",
        model: "Jacketed Design",
        image: "/products/ball-valves/3-way-ball-valve.png",
        images: [
          "/products/ball-valves/3-way-ball-valve.png",
          "/products/ball-valves/3-way-ball-valve-alt1.jpg",
          "/products/ball-valves/3-way-ball-valve-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 250 NB" },
          { key: "Pressure Rating", value: "ASME Class #150 / #300" },
          { key: "Design Temp.", value: "35°C to 280°C (Soft Seated)" },
          { key: "Design Standard", value: "ISO 17292, API 6D" },
          { key: "Testing Std.", value: "API 6D / BS EN ISO 5208 / API 598 / BS EN 12266-1" },
          { key: "Face to Face", value: "ASME B16.10" },
          { key: "End Connection", value: "Flanged ASME B16.5" },
          { key: "Flow Direction", value: "Bi-Directional" },
          { key: "Jacket Connection", value: "Flange / Coupling" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel" },
          { key: "Ball MOC", value: "Stainless Steel" },
          { key: "Seat Options", value: "GFT / CFT / TFM / PEEK" },
          { key: "Stem MOC", value: "SS 304 / SS 316 / F316L / F304L / 17-4PH" },
          { key: "Jacket MOC", value: "Carbon Steel / Stainless Steel" },
          { key: "Key Features", value: "Single Piece, Cavity Free, Full Bore, Fire Safe" },
        ],
      },
      {
        name: "3-Way Floating Ball Valve",
        model: "T & L Port Design",
        image: "/products/ball-valves/jacketed-ball-valve.png",
        images: [
          "/products/ball-valves/jacketed-ball-valve.png",
          "/products/ball-valves/jacketed-ball-valve-alt1.png",
          "/products/ball-valves/jacketed-ball-valve-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 250 NB" },
          { key: "Pressure Rating", value: "ASME Class #150 / #300" },
          ...
          { key: "End Connection", value: "Flanged ASME B16.5" },
          { key: "Flow Direction", value: "Bi-Directional" },
          { key: "Port Configurations", value: "T-Port & L-Port Flow Diverting" },
          { key: "Jacket Connection", value: "Flange / Coupling" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel" },
          { key: "Ball MOC", value: "Stainless Steel" },
      ...
      {
        name: "Flush Bottom / Tank Bottom Ball Valve",
        model: "Tank / Vessel Mounting",
        image: "/products/ball-valves/pfa-lined-ball-valve.png",
        images: [
          "/products/ball-valves/pfa-lined-ball-valve.png",
          "/products/ball-valves/pfa-lined-ball-valve-alt1.png",
          "/products/ball-valves/pfa-lined-ball-valve-alt2.jpg",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 250 NB" },
          { key: "Pressure Rating", value: "ASME Class #150 / #300 / #600" },
          ...
          { key: "Face to Face", value: "ASME B16.10" },
          { key: "End Connection", value: "Flanged ASME B16.5" },
          { key: "Flow Direction", value: "Uni-Directional" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel / Alloys" },
          { key: "Ball MOC", value: "Stainless Steel / Alloys" },
          { key: "Seat Options", value: "GFT / CFT / TFM / PEEK" },
          { key: "Stem MOC", value: "SS 304 / SS 316 / F316L / F304L / 17-4PH" },
          { key: "Jacket MOC", value: "Carbon Steel / Stainless Steel" },
          { key: "Key Features", value: "Cavity Free, Full Bore, Direct Mounting to Vessel Flange, Angled Stem Design, Double Sealing, One Piece Body" },
        ],
      },
      {
        name: "PFA Lined Ball Valve",
        model: "Corrosion Resistant Lined",
        image: "/products/ball-valves/tank-bottom-ball-valve.png",
        images: [
          "/products/ball-valves/tank-bottom-ball-valve.png",
          "/products/ball-valves/tank-bottom-ball-valve-alt1.png",
          "/products/ball-valves/tank-bottom-ball-valve-alt2.png",
        ],
        specs: [
          { key: "Size Range", value: "15 NB to 250 NB" },
          { key: "Pressure Rating", value: "ASME Class #150" },
          { key: "Design Temp.", value: "35°C to 200°C" },
          { key: "Design Standard", value: "BS EN 17292" },
          { key: "Testing Std.", value: "API 598 / BS EN 12266-1" },
          { key: "Face to Face", value: "ASME B16.10" },
          { key: "End Connection", value: "Flanged ASME B16.5" },
          { key: "Flow Direction", value: "Bi-Directional" },
          { key: "Operator", value: "Hand Lever / Gear Box / Actuator" },
          { key: "Body MOC", value: "Carbon Steel / Stainless Steel / Alloys" },
          { key: "Ball & Stem MOC", value: "Stainless Steel / Alloys" },
          { key: "Seat Options", value: "PTFE / TFM" },
          { key: "Lining MOC", value: "PFA / FEP / PVDF / ETFE / Antistatic PFA" },
        ],
      },
    ],
  },
  {
    ...
    images: [
      "/products/page7_img2_225x372.png",
      "/products/page7_img5_189x395.png",
      "/products/page7_img4_344x254.png",
      "/products/page7_img1_304x349.png",
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/products/page8_img2_369x349.png",
      "/products/page8_img1_306x234.png",
      "/products/page8_img4_221x358.png",
      "/products/page9_img4_234x316.png",
      "/products/page9_img1_135x201.png",
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/products/page10_img4_371x688.png",
      "/products/page9_img5_426x215.png",
      "/products/page10_img3_405x570.png",
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/products/page12_img1_465x354.png",
      "/products/page11_img1_165x248.png",
      "/products/page11_img2_158x285.png",
      "/products/page12_img2_206x341.png",
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/products/page16_img2_325x407.png",
      "/products/page17_img1_308x412.png",
      "/products/page18_img4_326x328.png",
      "/products/page18_img3_198x340.png",
      "/products/page18_img1_415x286.png",
      "/products/page19_img1_408x256.png",
    ],
    description:
  ...
  },
  {
    ...
    images: [
      "/products/page21_img5_612x205.png",
      "/products/page20_img2_116x242.png",
      "/products/page21_img1_147x342.png",
      "/products/page20_img7_105x149.png",
      "/products/page21_img2_129x343.png",
    ],
    description:
